...
export default function RegisterPage({ onNavigate }: Props) {
  ...
  const handleSocialLogin = (provider: string) => {
    addToast(`Connecting with ${provider}...`, 'info');
  };
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `radial-gradient(ellipse at center, ${tk.accent2}10, ${tk.accent1}08, transparent 70%)`,
          filter: 'blur(80px)',
        }}
      />
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p style={{ fontSize: 14, color: tk.textSecondary, margin: 0 }}>
              Start distilling documents into answers
            </p>
          </div>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <motion.button
              type="submit"
              disabled={loading || !displayName.trim() || !username.trim() || !password.trim()}
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          >
            Already have an account? <span style={{ color: tk.accent2, fontWeight: 500 }}>Sign in</span>
          </button>
          <button
            onClick={() => onNavigate('landing')}
